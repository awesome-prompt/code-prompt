...
Avoid overly verbose descriptions or unnecessary details. When possible, be VERY CONCISE in your description.
Start with a short sentence in imperative form, no more than 50 characters long.
Then leave an empty line and continue with a more detailed explanation, if necessary." : "Write a cohesive yet descriptive commit message for a given diff. 
